# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in xi-spike.
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': xispike.model,
    'DBSession': xispike.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "0419f2a6-22bb-4963-9334-a15a665f6f85",
